...
; PURPOSE:
;   Run end_to_end_powspec_lowell for lps12, using flatsky sims, K11 filtering
;
; INPUTS:
;
; NOTES:
...
;  06/25/2012: (KTS) make this run_07p6: Use flatsky sims from cr, K11 filtering
;;;

PRO try_end2end_07p6, $;field_idx, $
                    stopit=stopit, $
