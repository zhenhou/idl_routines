...
;  08/21/2012: (KTS) make this run_09p2_spec2: Pipeline test2, spec2, run_09
;  09/13/2012: (KTS) make this run_09p2_spec2_mcspec1: Pipeline test2, spec2, using spec1 as sims
;;;

PRO try_end2end_09p2_spec2_mcspec1, field_idx, $
                    stopit=stopit, $
...
;-------------------------
; Get transfer function, nbins, kernel, etc from normal run_09
;-------------------------
;end_file = '/home/kstory/lps12/end2end/end_ra3h30dec-60_09_kweight.sav'
;restore, end_file
...
;-------------------------
year = fst.year
;beamfiles = get_lps12_beams(year, l_beam, bl_beam, /d09)
