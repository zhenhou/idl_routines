...
;  09/25/2012: (KTS) make this run_09p3_spec1_mcspec0: Pipeline test3, spec1
;;;

PRO try_end2end_09p3_spec1_mcspec0, field_idx, $
                    stopit=stopit, $
...
; get MAPFILES
;-------------------------
mapfiles = file_search('/data23/kstory/lps12/sims/pipetest3/coaddsim_pipetest3_spec1_'+field_name+'.dat')
mapname = 'coadd'
