...
;  04/38/2013: (KTS) Modify for "ptscor"
;;;

PRO try_end2end_ptscor, field_idx, $
                        stopit=stopit, $
...
mask_dir    = '/home/kstory/lps12/masks/0428_ptscor/'
kern_dir    = mask_dir
...
; get MAPFILES
;-------------------------
mapfiles = get_lps12_runlist_ptscor(field_idx, /xspec_maps)
...
;restore, kernfile ; Don't have any kerns...
