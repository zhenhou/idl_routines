...
for ii=0, 20 do begin
    make_ptsrc_mask_0305, ii
endfor
end

;...................................................................
; Make point source mask for one field
pro make_ptsrc_mask_0305, field_idx, cut_type=cut_type, stopit=stopit
...
ptsrc_file='/home/kstory/lps12/ptsrc_lists/ptsrc_config_'+cut_type+'_'+field_name+'_*.txt'
...
nx = npix[0]
ny = npix[1]
savename='/home/kstory/lps12/masks/ptsrc_0305/ptsrc_mask_'+field_name+'_'+cut_type+'_proj'+strtrim(floor(proj),2)+'.sav'
