...
window, 1
plot, l[whplot], (ks07p6_diag/ks_diag)[whplot], yr=[.7,1.3],/yst,title='Errors, 7p6, ra21hdec-50', $ ; tot
  ytitle='err_07p6 / err_07', xtitle='ell'
oplot, l[whplot], (ks07p6_diag_meas/ks_diag_meas)[whplot], color=!skyblue         ; meas
oplot, l[whplot], (ks07p6_diag_sv/ks_diag_sv)[whplot], color=!green               ; sv
legend, ['Tot', 'SV', 'NV'], color=[!white, !green, !skyblue], linestyle=[0,0,0], pos=[600, 1.2]
;err=tvread(/png,/nodialog,filename=fdir+'err_07p6_vs_07_0624')

window, 2
plot, l[whplot], (rk_diag/ks07p6_diag)[whplot], yr=[.7,1.3],/yst,title='Errors, 7p6, ra21hdec-50', $ ; tot
...
legend, ['Tot', 'SV', 'NV'], color=[!white, !green, !skyblue], linestyle=[0,0,0], pos=[600, 1.2]
;err=tvread(/png,/nodialog,filename=fdir+'err_rk_vs_07p6_0624')
...
window, 4
plot, l[whplot], (ks07p6_diag/ks07p5_diag)[whplot], yr=[.7,1.3],/yst,title='Errors, 7p6, ra21hdec-50', $ ; tot
  ytitle='err_07p6 / err_07p5', xtitle='ell'
;oplot, l[whplot], (ks07p6_diag_meas/ks07p5_diag_meas)[whplot], color=!skyblue         ; meas
oplot, l[whplot], (ks07p6_diag_sv/ks07p5_diag_sv)[whplot], color=!green               ; sv
legend, ['Tot', 'SV', 'NV'], color=[!white, !green, !skyblue], linestyle=[0,0,0], pos=[600, 1.2]
err=tvread(/png,/nodialog,filename=fdir+'err_07p6_vs_07p5_0624')
...
;;;;;;;;;;;;;;;;;;;;
; Make rk kweight into 4320x4320
;;;;;;;;;;;;;;;;;;;;

PRO mk_weight

restore, '/home/rkeisler/ps09/1.37/end_ra21hdec-50_1.37_kweight.sav'
weight_2d = congrid(weight_2d,4320,4320)
save, weight_2d, filename='/home/kstory/lps12/end2end/run_07p1/rktmp_weight_2d_07p7.sav'
