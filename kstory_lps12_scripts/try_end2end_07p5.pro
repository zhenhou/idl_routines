...
; PURPOSE:
;   Run end_to_end_powspec_lowell for lps12, using flatsky sims
;
; INPUTS:
;
; NOTES:
...
;  06/24/2012: (KTS) make this run_07p5: Use flatsky sims from cr
;;;

PRO try_end2end_07p5, $;field_idx, $
                    stopit=stopit, $
...
; directories
sim_dir     = '/home/kstory/lps12/sims/kstestsims/' ; soft-linked to /data23/
...
sbeamdir='/home/cr/data/spt_beams_2009/v1/'
simbeamfiles = sbeamdir+'bl_spt_2009_150.txt'
