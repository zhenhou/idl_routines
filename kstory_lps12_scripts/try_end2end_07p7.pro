...
; PURPOSE:
;   Run end_to_end_powspec_lowell for lps12, using flatsky sims with
;   K11 filtering, k11 kweight
;
; INPUTS:
;
; NOTES:
...
;  06/25/2012: (KTS) make this run_07p7:
;;;

PRO try_end2end_07p7, $;field_idx, $
                    stopit=stopit, $
...
run = '07p7_flatsky_k11filtering_k11kweight'

; directories
sim_dir     = '/home/kstory/lps12/sims/kstestsims2/' ; soft-linked to /data23/
workdir     = '/home/kstory/lps12/scratch/'+field_name+'_'+run+'/' ; soft-linked to /data23/
...
; get MCFILES
;-------------------------
mcfiles = [[[sim_dir+'coaddsim_r11_'+field_name+'.dat']]]
mcmapname = 'coadd'
...
spectrumfiles=['/home/cr/cmb_models/wmap7_lcdm_lensedCls_extended.dat', $
               '/home/cr/paramfits/cosmomc.s10/data/dl_ksz_sehgal.txt',$
               '/home/cr/cmb_models/foreground_sim09_150.txt']
print, 'spectrumfiles = ', spectrumfiles
...
;;; Use RK's kmask instead
restore, '/home/kstory/lps12/end2end/run_07p1/rktmp_weight_2d_07p7.sav'
kmask = weight_2d ; 4320 x 4320
