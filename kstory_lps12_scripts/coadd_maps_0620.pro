...
;...................................................................
; coadd all maps from one field from the maps/20120620/ directories
;
PRO coadd_maps_0620, field_idx, $
                     coadd_dir = coadd_dir
...
; 50 mJy ptsrc cut
;------------------------
coadd_dir = '/data/kstory/projects/lps12/maps/20120620/coadds/'
...
; Coadd the maps
;------------------------
print, 'COADD_MAPS_0620: output = ', coadd_name
...
for ii=0, n_elements(field_list) -1 do begin
    ...
    endif else coadd_maps_0620, field_list[ii]
endfor
end
