...
for ii=0, 19 do begin
    mk_make_maps_script_0620, ii
endfor

; treat ra5h30dec-55_2011 differently
;MK_MAKE_MAPS_SCRIPT_0620, 20, runlist='/data/kstory/projects/lps12/runlists/runlist_allidf_ra5h30dec-55_2011.txt'
end


;...................................................................
; Make the runscript for a given field
pro mk_make_maps_script_0620, idx, runlist=runlist
...
ds = double(4)
if ( intersect(idx, [0,1,3,4,5,20]) ne -1 ) then begin
    ds = double(6)
endif 
