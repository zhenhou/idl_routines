...
pro make_apod_mask_0312, field_idx, $
                         overlap=overlap, $
                         use_nmiss=use_nmiss, $
...
; Output dir
savdir = '/home/kstory/lps12/masks/apod_0312/'

; coadd dir
if ~keyword_set(use_nmiss) then coadd_dir = '/data/kstory/projects/lps12/maps/20120305/coadds/'
...
print, 'MAKE_APOD_MASK_0312, field = ', field_name
...
if keyword_set(use_nmiss) then begin
    print, 'MAKE_APOD_MASK_0312, USE EXP(-NMISS) METHOD'
...
; Option 1: use the weight mask
    ...
    print, 'MAKE_APOD_MASK_0312, USE WEIGHT_MAP METHOD'
...
print, "MAKE_APOD_MASK_0312, output mask it file:"
print, "   "+savename
