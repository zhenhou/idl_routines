...
;for iidf=244, 245 do begin
    ...
    for iscan=0, nscans - 1 do begin
        ...
        if scan_flag[iscan] eq 0 then begin
            ...
            dmap_sign[iscan] =  abs(ra_bs[10]-ra_bs[0]) lt 180 ? dmap_sign[iscan] : -1.0*dmap_sign[iscan] ;
...
savname='/home/kstory/lps12/scripts/sav_files/lr_test_0317_'+field_name+'.sav'
...
fname = '/home/kstory/lps12/figs/'+field_name+'_lr_weights_0317'
