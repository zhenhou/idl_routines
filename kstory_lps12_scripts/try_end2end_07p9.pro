...
; PURPOSE:
;   Run end_to_end_powspec_lowell for lps12, using K11 sims
;
; INPUTS:
;
; NOTES:
...
;  06/25/2012: (KTS) make this run_07p9:
;;;

PRO try_end2end_07p9, $;field_idx, $
                    stopit=stopit, $
...
end_to_end_powspec_lps12_07p9, mapfiles, mcfiles, mask_padded, reso_arcmin, f0,$
