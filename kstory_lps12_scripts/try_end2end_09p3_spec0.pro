...
;  09/20/2012: (KTS) make this run_09p3_spec0: Pipeline test3, spec0
;;;

PRO try_end2end_09p3_spec0, field_idx, $
                    stopit=stopit, $
...
; get MAPFILES
;-------------------------
mapfiles = file_search('/data23/kstory/lps12/sims/pipetest3/coaddsim_pipetest3_spec0_'+field_name+'.dat')
mapname = 'coadd'
