...
;  08/30/2012: (KTS) make this run_09p2_spec1: Pipeline test2, spec1,
;                    run_09, fix beams again
;;;

PRO try_end2end_09p2_spec1, field_idx, $
                    stopit=stopit, $
...
mapfiles = file_search('/data23/kstory/lps12/sims/pipetest2/coaddsim_pipetest2_spec1_'+field_name+'.dat')
mapname = 'coadd'
