...
; run_08 ;0809 only
restore, '/home/kstory/lps12/end2end/run_08/combined_spectrum_20120718_132910_kweight_0809.sav'
dl08_08 = dl_all
diag08_0809 = diag_nobeam
...
window, 2
plot, l[whplot], ((err_rk )/diag08)[whplot], $
...
window, 3
plot, l[whplot], ((err_rk )/diag07)[whplot], $
  xtitle=xtitle, ytitle='err_k11/err_07', title='Error bars, K11 v.s. 2500'
oplot, [0,10000], [sqrt(2500./790.),sqrt(2500./790.)], linestyle=1, thick=3
;err=tvread(/png,/nodialog,filename=fdir+'err_k11v07_0617')

window, 4
plot, l[whplot], ((err_rk )/diag07_0809)[whplot], $
  xtitle=xtitle, ytitle='err_k11/err_07', title='Error bars, K11 v.s. 0809 only'

window, 5
plot, l[whplot], ((err_rk )/diag08_0809)[whplot], $
  xtitle=xtitle, ytitle='err_k11/err_08', title='Error bars, K11 v.s. 0809 only'

window, 6
plot, l[whplot], ((diag07_0809 )/diag08_0809)[whplot], $
  xtitle=xtitle, ytitle='diag07_0809/diag08_0809', title='Error bars, run07 v.s. run08, 0809 only'
