...
dir = '/data/kstory/projects/lps12/scripts/plotting/alens_1127/'
readcol, dir+'alensLike_w7_1127.txt',b_w7,h_w7,format='d,d'
readcol, dir+'alensLike_s12_1127.txt',b_s12,h_s12,format='d,d'
readcol, dir+'alensLike_cmb_1127.txt',b_cmb,h_cmb,format='d,d'

xr=[-0.2,2.2]
yr=[0,1]

plot, b_cmb,h_cmb, linestyle=0,xr=xr,/xst,yr=yr,/yst
oplot, b_cmb,h_cmb, linestyle=0
oplot, b_w7,h_w7, color=!red, linestyle=2
oplot, b_s12,h_s12, color=!blue, linestyle=3
...
filename_stub = '~kstory/lps12/scripts/figs/alens_1127'
...
plot_like1dname,files_cmb,pname_cmb,'alens',subsamp=8,nskip=1000,$
  thick=7,linestyle=ls[1], color=color_cmb, /oplot
...
plot_like1dname,files_s12,pname_s12,'alens',subsamp=3,nskip=1000,$
  thick=7,linestyle=2, color=color_s12, /oplot
...
;---------------------------
; over-plot txt file values
dir = '/data/kstory/projects/lps12/scripts/plotting/alens_1127/'
readcol, dir+'alensLike_w7_1127.txt',b_w7,h_w7,format='d,d'
readcol, dir+'alensLike_s12_1127.txt',b_s12,h_s12,format='d,d'
readcol, dir+'alensLike_cmb_1127.txt',b_cmb,h_cmb,format='d,d'

oplot, b_cmb,h_cmb, color=pscolors[3], linestyle=2, thick=7
oplot, b_w7,h_w7, color=pscolors[9], linestyle=2, thick=7
oplot, b_s12,h_s12, color=pscolors[4], linestyle=3, thick=7
