...
pro make_apod_mask_0306, field_idx, $
                         overlap=overlap, $
...
; Output dir
savdir = '/home/kstory/lps12/masks/apod_0307/'
...
print, 'MAKE_APOD_MASK_0306, field = ', field_name
...
;if keyword_set(allow_overlap) then savename=savdir+'apod_allow_overlap_'+field_name+'_'+staper+'_'+sthresh+'_'+ssmooth+'.sav'
print, "MAKE_APOD_MASK_0306, output mask it file:"
print, "   "+savename
