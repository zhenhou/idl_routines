...
;...................................................................
; Main Function
FUNCTION get_lps12_runlist_ptscor, field_idx, idfs=idfs, full_idfs=full_idfs, obs_maps=obs_maps, obs_dates=obs_dates, $
...
if ( ~keyword_set(idfs) and $
     ...
     ~keyword_set(xspec_dates) and $
     ~keyword_set(preaz_dates) ) then begin
...
if keyword_set(xspec_maps) then begin
    ...
    if fst.lead_trail eq 1 then begin
        map_dir = '/home/kstory/lps12/maps/20130428/'+field_name+'_lt/'
    endif else begin
        map_dir = '/home/kstory/lps12/maps/20130428/'+field_name+'/'
    endelse
