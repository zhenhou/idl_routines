;;;
; NAME: coadd_maps_ptscor_0428.pro
; PURPOSE:
;   Coadd maps
;
; INPUTS
...
;  03/12/2012: (KTS) copy from coadd_maps_0305
;  04/04/2013: (KTS) copy from coadd_maps_0620 (uses wrong runlists, 20120620 maps)
;  04/30/2013: (KTS) Correct to use get_lps12_runlist_planck_spt.pro
;  04/30/2013: (KTS) Modified for "ptscor"
;;;


;...................................................................
; coadd all maps from one field from the maps/20120403/ directories
;
PRO coadd_maps_ptscor_0428, field_idx, $
                            coadd_dir = coadd_dir
...
; 50 mJy ptsrc cut
;------------------------
coadd_dir = '/data/kstory/projects/lps12/maps/20130428/coadds/'
...
maps = get_lps12_runlist_ptscor(field_idx, /xspec_maps)
...
; Coadd the maps
;------------------------
print, 'COADD_MAPS_0403: output = ', coadd_name
...
for ii=0, n_elements(field_list) -1 do begin
    ...
    endif else coadd_maps_0403, field_list[ii]
endfor
end
...
; 50 mJy ptsrc cut
;------------------------
coadd_dir = '/data/kstory/projects/lps12/maps/20130403/coadds/'
...
dates = get_lps12_runlist_ptscor(field_idx, /xspec_dates)
;maps   = get_lps12_runlist(field_idx, /xspec_maps)
maps = get_lps12_runlist_ptscor(field_idx, /xspec_maps)
