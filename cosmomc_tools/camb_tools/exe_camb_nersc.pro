pro exe_camb_nersc, params, output_root, cls, old_camb=old_camb, camb_path=camb_path, pivot_k=pivot_k, add=add
    
    if (not keyword_set(camb_path)) then camb_path = '/global/homes/h/hou/Projects/CMBtools/cosmologist.info/camb'
    camb = camb_path+'/camb'
    ...
    fmt = '(A,D16.7)'
    ini_file = '/global/homes/h/hou/tmp/'+output_root+'.ini'
    get_lun, unit_ini
    ...
    endelse
    printf, unit_ini, 'output_root     = /global/homes/h/hou/tmp/'+output_root
    ...
    lensedcls_file = '/global/homes/h/hou/tmp/'+output_root+'_lensedCls.dat'
    ...
    scalcls_file = '/global/homes/h/hou/tmp/'+output_root+'_lenspotentialCls.dat'
    ...
    spawn, 'rm -rf /global/homes/h/hou/tmp/'+output_root+'_*'
