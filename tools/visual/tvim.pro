...
nxm=nx-1
nym=ny-1
plot, [0,1],[0,1],/nodata,xstyle=4,ystyle=4,charsize=pcharsize, color=0
...
case 1 of 
  ...
  keyword_set(noframe):plot,[0,0],[0,0],xstyle=5,ystyle=5,position=pos,$
                         title=title,/device, charsize=pcharsize, color=0,$
                         xrange=xrng,yrange=yrng,/noerase,/nodata
                         
  keyword_set(noaxis): plot,[0,0],[0,0],/xstyle,/ystyle,position=pos,$
                         title=title,xtitle=xtitle,ytitle=ytitle, color=0, /device, $
                         xrange=xrng,yrange=yrng,/noerase,/nodata,$
                         ...
                         position=pos,/noerase, color=0, /device,charsize=pcharsize
endcase
;
