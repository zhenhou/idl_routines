pro run_scanmap_sims_coadd_aspec, field_idx, sim_map_root, num_sims, $
    mapname=mapname, $
    ...
    for isim=0, num_sims-1 do begin
        ...
        if res.exists then begin
            ...
            sim_map_fits = [sim_map_dir+sim_map_root+'_'+intfile_ident+'.fits']

            end_to_end_powspec_data, sim_map_fits, mask_padded, reso_arcmin, $
